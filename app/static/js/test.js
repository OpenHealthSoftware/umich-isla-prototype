...
for (var c in origCoords)
{
    ...
    cell.draw(function(t){
        ...
        console.log(img, minX, minY, cellWidth, cellHeight, 0,0, t.canvas.width, t.canvas.height);
